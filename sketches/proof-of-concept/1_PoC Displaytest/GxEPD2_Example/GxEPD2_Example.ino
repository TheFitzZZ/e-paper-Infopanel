...
char HelloWorld[] = "Hallo World!";
char HelloArduino[] = "Hallo Arduino!";
char HelloEpaper[] = "Hallo E-Paper!";
...
void helloFullScreenPartialMode()
{
  ...
  char fpm[] = "fast partial mode";
  char spm[] = "slow partial mode";
  char npm[] = "no partial mode";
...
void deepSleepTest()
{
  ...
  char hibernating[] = "hibernating ...";
  char wokeup[] = "woke up from deep sleep";
  char again[] = "hibernating again ...";
  display.setRotation(1);
  display.setFont(&FreeMonoBold9pt7b);
  display.setTextColor(GxEPD_BLACK);
  int16_t tbx, tby; uint16_t tbw, tbh;
...
void showFont(char name[], const GFXfont* f)
{
  display.setFullWindow();
...
void drawFont(char name[], const GFXfont* f)
{
  //display.setRotation(0);
  display.fillScreen(GxEPD_WHITE);
  display.setTextColor(GxEPD_BLACK);
